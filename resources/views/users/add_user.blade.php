                ...
                <div class="col-12">
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <form id="kt_ecommerce_settings_general_form" enctype="multipart/form-data" method="POST" action="create_user" class="form" action="#">
                                @csrf
                                <div class="mb-7">
                                    ...
                                    <div class="mt-1">
                                        <style>.image-input-placeholder { background-image: url('{{asset("/storage/assets/assets/media/svg/files/blank-image.svg")}}') } [data-theme="dark"] .image-input-placeholder { background-image: url('../../assets/media/svg/files/blank-image-dark.svg'); }</style>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12 date" placeholder="Pick date range" name="dob" />                                                                                            
                                            </div>
                                            @error('dob')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input placeholder="Designation" type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" value="{{old('designation')}}" />
                                            @error('designation')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <textarea class="form-control" name="about_me" placeholder="About Me">{{old('about_me')}}</textarea>
                                        @error('about_me')
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>   
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input placeholder="Account Number" type="text" class="form-control @error('account_no') is-invalid @enderror" name="account_no" value="{{old('account_no')}}" />
                                            @error('account_no')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input placeholder="Bank Name" type="text" class="form-control @error('bank_name') is-invalid @enderror" name="bank_name" value="{{old('bank_name')}}" />
                                            @error('bank_name')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input placeholder="Account Holder Name" type="text" class="form-control @error('account_holder_name') is-invalid @enderror" name="account_holder_name" value="{{old('account_holder_name')}}" />
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input placeholder="IFSC Code" type="text" class="form-control @error('ifsc_code') is-invalid @enderror" name="ifsc_code" value="{{old('account_holder_name')}}" />
                                            @error('ifsc_code')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea class="form-control" name="bank_address" placeholder="Bank Address">{{old('bank_address')}}</textarea>
                                            @error('bank_address')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12 date" placeholder="Joining Date" name="joining_date" />                                                                                            
                                            </div>
                                            @error('joining_date')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12 date" placeholder="Last Increment Date" name="last_increment_date" />                                                                                            
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <input class="form-control form-control-solid ps-12 date" placeholder="Next Increment Date" name="next_increment_date" />                                                                                            
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-7">
                                            ...
                                            <input placeholder="Basic Salary" type="text" class="form-control @error('basic_salary') is-invalid @enderror" name="basic_salary" value="{{old('basic_salary')}}" />
                                            @error('basic_salary')
                                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
